...
enum PeopleInfo_Phone_PhoneType : int {
  ...
  PeopleInfo_Phone_PhoneType_TLP = 1,
...
constexpr PeopleInfo_Phone_PhoneType PeopleInfo_Phone_PhoneType_PhoneType_MAX = PeopleInfo_Phone_PhoneType_TLP;
...
class PeopleInfo_Phone final :
 ...
 public:
  ...
  static constexpr PhoneType TLP =
    PeopleInfo_Phone_PhoneType_TLP;
...
class PeopleInfo final :
 ...
 public:
  ...
  ::contact2::PeopleInfo_Phone* mutable_phone_numbers(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::contact2::PeopleInfo_Phone >*
      mutable_phone_numbers();
  private:
  const ::contact2::PeopleInfo_Phone& _internal_phone_numbers(int index) const;
  ::contact2::PeopleInfo_Phone* _internal_add_phone_numbers();
  public:
  const ::contact2::PeopleInfo_Phone& phone_numbers(int index) const;
  ::contact2::PeopleInfo_Phone* add_phone_numbers();
  ...
  public:
  void clear_wc();
  const std::string& wc() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_wc(ArgT0&& arg0, ArgT... args);
  std::string* mutable_wc();
  PROTOBUF_NODISCARD std::string* release_wc();
  void set_allocated_wc(std::string* wc);
  private:
  const std::string& _internal_wc() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_wc(const std::string& value);
  std::string* _internal_mutable_wc();
  public:
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::contact2::PeopleInfo_Phone > phone_numbers_;
    ...
    union OtherContactUnion {
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr wc_;
    } other_contact_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
...
inline const std::string& Address::home_addr() const {
  // @@protoc_insertion_point(field_get:contact2.Address.home_addr)
...
void Address::set_home_addr(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.home_addr_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:contact2.Address.home_addr)
}
inline std::string* Address::mutable_home_addr() {
  std::string* _s = _internal_mutable_home_addr();
  // @@protoc_insertion_point(field_mutable:contact2.Address.home_addr)
  return _s;
}
...
inline std::string* Address::release_home_addr() {
  // @@protoc_insertion_point(field_release:contact2.Address.home_addr)
...
inline void Address::set_allocated_home_addr(std::string* home_addr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:contact2.Address.home_addr)
}
...
inline const std::string& Address::unit_addr() const {
  // @@protoc_insertion_point(field_get:contact2.Address.unit_addr)
...
void Address::set_unit_addr(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.unit_addr_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:contact2.Address.unit_addr)
}
inline std::string* Address::mutable_unit_addr() {
  std::string* _s = _internal_mutable_unit_addr();
  // @@protoc_insertion_point(field_mutable:contact2.Address.unit_addr)
  return _s;
}
...
inline std::string* Address::release_unit_addr() {
  // @@protoc_insertion_point(field_release:contact2.Address.unit_addr)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:contact2.Address.unit_addr)
}
...
inline ::contact2::PeopleInfo_Phone* PeopleInfo::mutable_phone_numbers(int index) {
  // @@protoc_insertion_point(field_mutable:contact2.PeopleInfo.phone_numbers)
...
PeopleInfo::mutable_phone_numbers() {
  // @@protoc_insertion_point(field_mutable_list:contact2.PeopleInfo.phone_numbers)
  return &_impl_.phone_numbers_;
}
inline const ::contact2::PeopleInfo_Phone& PeopleInfo::_internal_phone_numbers(int index) const {
  return _impl_.phone_numbers_.Get(index);
}
inline const ::contact2::PeopleInfo_Phone& PeopleInfo::phone_numbers(int index) const {
  // @@protoc_insertion_point(field_get:contact2.PeopleInfo.phone_numbers)
  return _internal_phone_numbers(index);
}
inline ::contact2::PeopleInfo_Phone* PeopleInfo::_internal_add_phone_numbers() {
  return _impl_.phone_numbers_.Add();
}
inline ::contact2::PeopleInfo_Phone* PeopleInfo::add_phone_numbers() {
  ::contact2::PeopleInfo_Phone* _add = _internal_add_phone_numbers();
  // @@protoc_insertion_point(field_add:contact2.PeopleInfo.phone_numbers)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::contact2::PeopleInfo_Phone >&
PeopleInfo::phone_numbers() const {
  // @@protoc_insertion_point(field_list:contact2.PeopleInfo.phone_numbers)
  return _impl_.phone_numbers_;
}
...
// string wc = 6;
inline bool PeopleInfo::_internal_has_wc() const {
  return other_contact_case() == kWc;
}
inline bool PeopleInfo::has_wc() const {
  return _internal_has_wc();
}
inline void PeopleInfo::set_has_wc() {
  _impl_._oneof_case_[0] = kWc;
}
inline void PeopleInfo::clear_wc() {
  if (_internal_has_wc()) {
    _impl_.other_contact_.wc_.Destroy();
    clear_has_other_contact();
  }
}
inline const std::string& PeopleInfo::wc() const {
  // @@protoc_insertion_point(field_get:contact2.PeopleInfo.wc)
  return _internal_wc();
}
template <typename ArgT0, typename... ArgT>
inline void PeopleInfo::set_wc(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_wc()) {
    clear_other_contact();
    set_has_wc();
    _impl_.other_contact_.wc_.InitDefault();
  }
  _impl_.other_contact_.wc_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:contact2.PeopleInfo.wc)
}
inline std::string* PeopleInfo::mutable_wc() {
  std::string* _s = _internal_mutable_wc();
  // @@protoc_insertion_point(field_mutable:contact2.PeopleInfo.wc)
  return _s;
}
inline const std::string& PeopleInfo::_internal_wc() const {
  if (_internal_has_wc()) {
    return _impl_.other_contact_.wc_.Get();
  }
  return ::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited();
}
inline void PeopleInfo::_internal_set_wc(const std::string& value) {
  if (!_internal_has_wc()) {
    clear_other_contact();
    set_has_wc();
    _impl_.other_contact_.wc_.InitDefault();
  }
  _impl_.other_contact_.wc_.Set(value, GetArenaForAllocation());
}
inline std::string* PeopleInfo::_internal_mutable_wc() {
  if (!_internal_has_wc()) {
    clear_other_contact();
    set_has_wc();
    _impl_.other_contact_.wc_.InitDefault();
  }
  return _impl_.other_contact_.wc_.Mutable(      GetArenaForAllocation());
}
inline std::string* PeopleInfo::release_wc() {
  // @@protoc_insertion_point(field_release:contact2.PeopleInfo.wc)
  if (_internal_has_wc()) {
    clear_has_other_contact();
    return _impl_.other_contact_.wc_.Release();
  } else {
    return nullptr;
  }
}
inline void PeopleInfo::set_allocated_wc(std::string* wc) {
  if (has_other_contact()) {
    clear_other_contact();
  }
  if (wc != nullptr) {
    set_has_wc();
    _impl_.other_contact_.wc_.InitAllocated(wc, GetArenaForAllocation());
  }
  // @@protoc_insertion_point(field_set_allocated:contact2.PeopleInfo.wc)
}
...
// repeated .contact2.PeopleInfo contacts = 1;
inline int Contact::_internal_contacts_size() const {
  return _impl_.contacts_.size();
}
inline int Contact::contacts_size() const {
  return _internal_contacts_size();
}
inline void Contact::clear_contacts() {
  _impl_.contacts_.Clear();
}
inline ::contact2::PeopleInfo* Contact::mutable_contacts(int index) {
  // @@protoc_insertion_point(field_mutable:contact2.Contact.contacts)
  return _impl_.contacts_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::contact2::PeopleInfo >*
Contact::mutable_contacts() {
  // @@protoc_insertion_point(field_mutable_list:contact2.Contact.contacts)
  return &_impl_.contacts_;
}
inline const ::contact2::PeopleInfo& Contact::_internal_contacts(int index) const {
  return _impl_.contacts_.Get(index);
}
inline const ::contact2::PeopleInfo& Contact::contacts(int index) const {
  // @@protoc_insertion_point(field_get:contact2.Contact.contacts)
  return _internal_contacts(index);
}
inline ::contact2::PeopleInfo* Contact::_internal_add_contacts() {
  return _impl_.contacts_.Add();
}
inline ::contact2::PeopleInfo* Contact::add_contacts() {
  ::contact2::PeopleInfo* _add = _internal_add_contacts();
  // @@protoc_insertion_point(field_add:contact2.Contact.contacts)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::contact2::PeopleInfo >&
Contact::contacts() const {
  // @@protoc_insertion_point(field_list:contact2.Contact.contacts)
  return _impl_.contacts_;
}
