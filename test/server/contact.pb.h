...
PROTOBUF_NAMESPACE_OPEN
template<> ::s_contact::PeopleInfo* Arena::CreateMaybeMessage<::s_contact::PeopleInfo>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace s_contact {
...
class PeopleInfo final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:s_contact.PeopleInfo) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:s_contact.PeopleInfo)
 private:
  class _Internal;
...
inline const std::string& PeopleInfo::name() const {
  // @@protoc_insertion_point(field_get:s_contact.PeopleInfo.name)
...
void PeopleInfo::set_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:s_contact.PeopleInfo.name)
}
inline std::string* PeopleInfo::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:s_contact.PeopleInfo.name)
  return _s;
}
...
inline std::string* PeopleInfo::release_name() {
  // @@protoc_insertion_point(field_release:s_contact.PeopleInfo.name)
...
inline void PeopleInfo::set_allocated_name(std::string* name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:s_contact.PeopleInfo.name)
}
...
inline int32_t PeopleInfo::birthday() const {
  // @@protoc_insertion_point(field_get:s_contact.PeopleInfo.birthday)
...
inline void PeopleInfo::set_birthday(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:s_contact.PeopleInfo.birthday)
}
