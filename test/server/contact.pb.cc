...
const uint32_t TableStruct_contact_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::s_contact::PeopleInfo, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::s_contact::PeopleInfo, _impl_.name_),
  PROTOBUF_FIELD_OFFSET(::s_contact::PeopleInfo, _impl_.birthday_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::s_contact::PeopleInfo)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::s_contact::_PeopleInfo_default_instance_._instance,
};

const char descriptor_table_protodef_contact_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\rcontact.proto\022\ts_contact\"2\n\nPeopleInfo"
  "\022\014\n\004name\030\001 \001(\t\022\020\n\010birthday\030\005 \001(\005J\004\010\002\020\003b\006"
  "proto3"
  ;
static ::_pbi::once_flag descriptor_table_contact_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_contact_2eproto = {
    false, false, 86, descriptor_table_protodef_contact_2eproto,
    "contact.proto",
...
PeopleInfo::PeopleInfo(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:s_contact.PeopleInfo)
}
PeopleInfo::PeopleInfo(const PeopleInfo& from)
  ...
  // @@protoc_insertion_point(copy_constructor:s_contact.PeopleInfo)
}
...
PeopleInfo::~PeopleInfo() {
  // @@protoc_insertion_point(destructor:s_contact.PeopleInfo)
...
// @@protoc_insertion_point(message_clear_start:s_contact.PeopleInfo)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "s_contact.PeopleInfo.name"));
        } else
          goto handle_unusual;
        continue;
      // int32 birthday = 5;
...
uint8_t* PeopleInfo::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:s_contact.PeopleInfo)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (this->_internal_birthday() != 0) {
    ...
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(5, this->_internal_birthday(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:s_contact.PeopleInfo)
  return target;
}

size_t PeopleInfo::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:s_contact.PeopleInfo)
  size_t total_size = 0;
...
void PeopleInfo::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:s_contact.PeopleInfo)
...
// @@protoc_insertion_point(class_specific_copy_from_start:s_contact.PeopleInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::s_contact::PeopleInfo*
Arena::CreateMaybeMessage< ::s_contact::PeopleInfo >(Arena* arena) {
  return Arena::CreateMessageInternal< ::s_contact::PeopleInfo >(arena);
}
